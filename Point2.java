...
class LabeledPoint extends Point2 {
    ...
    public static void main(String[] args) {
        LabeledPoint llpoint1 = new LabeledPoint("LabeledPoint", 1.0, 1.0);
        System.out.println(llpoint1);
        LabeledPoint lpoint2 = new LabeledPoint("LabeledPoint", 1.0, 1.0);
        System.out.println(llpoint1.equals(lpoint2));
        System.out.println(llpoint1.hashCode());
